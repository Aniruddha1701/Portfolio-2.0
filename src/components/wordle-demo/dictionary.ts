// 1. Solution Dictionary: Curated High-Quality Tech Terms
export const SOLUTIONS = [
    "STACK", "QUEUE", "ARRAY", "CACHE", "PROXY",
    "REACT", "GRAPH", "QUERY", "FETCH", "CONST",
    "AWAIT", "ASYNC", "BLOCK", "SCOPE", "CLASS",
    "MODEL", "ROUTE", "TOKEN", "LOGIN", "ADMIN",
    "INPUT", "STATE", "EVENT", "HOOKS", "MOUNT",
    "BUILD", "DEBUG", "ERROR", "PATCH", "MERGE",
    "CLONE", "AXIOS", "REDIS", "MONGO", "MYSQL",
    "CLOUD", "AZURE", "LINUX", "SHELL", "PIXEL",
    "IMAGE", "VIDEO", "AUDIO", "BYTES", "LOGIC",
    "SOLID", "AGILE", "SCRUM", "KANBAN", "SLACK",
    "NODES", "TREES", "HEAPS", "VIEWS", "TYPES",
    "BYTES"
];

// 2. Guess Dictionary: Larger set for validation (includes Solutions + Common English)
// Ideally this would be a large JSON, but for this portfolio demo we include a focused set
// plus common words to avoid "unknown word" frustration for valid inputs.
export const VALID_GUESSES = [
    ...
    "ARISE", "ARMED", "ARROW", "ASIDE", "ASSET", "AUDIO", "AUDIT", "AVOID", "AWARD", "AWARE",
    ...
    "BROAD", "BROWN", "BRUSH", "BUILD", "BUILT", "BUYER", "CABLE", "CALIF", "CARRY", "CATCH",
    ...
    "HUMAN", "IDEAL", "IMAGE", "INDEX", "INNER", "INPUT", "ISSUE", "IRON", "ITEM", "JOINT",
    "JUDGE", "JUICE", "JIMMY", "JONES", "KEPT", "KILL", "KNOWN", "LABEL", "LARGE", "LASER",
    ...
    "TAXES", "TEACH", "TEETH", "TERRY", "TEXAS", "THANK", "THEIR", "THEME", "THERE", "THESE",
    ...
    "YIELD", "YOUNG", "YOUTH",
    // Common Tech Plurals & Past Tense
    "CODES", "LINKS", "SITES", "TOOLS", "USERS", "TESTS", "WARNS", "FILES", "LOADS",
    "FIXED", "ADDED", "TYPED", "SAVED", "MOVED", "CLICK", "PRESS", "LOCKS", "VIEWS",
    "NODES", "TREES", "HEAPS", "TYPES", "BYTES", "CLONE", "FETCH", "MERGE"
];
