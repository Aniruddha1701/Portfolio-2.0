...
const SocialLinks = () => (
  <div className="fixed top-1/2 right-4 -translate-y-1/2 z-50 hidden md:flex flex-col gap-4">
    ...
    <a href="https://linkedin.com/in/aniruddhapatil0593" aria-label="LinkedIn" target="_blank" className="p-2 rounded-full bg-background/80 backdrop-blur-md hover:bg-primary/10 transition-colors">
      <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 24 24" className="text-foreground">
