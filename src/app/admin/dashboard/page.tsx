  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-40 left-1/2 w-80 h-80 bg-blue-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-blob animation-delay-4000" />
      </div>

      {/* Enhanced Header */}
      <header className="relative bg-gray-900/50 backdrop-blur-xl border-b border-gray-800">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400 mt-1">
                  Welcome back, {portfolio?.personalInfo?.name || 'Admin'}
                </p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              {/* Profile Completion Indicator */}
              <div className="hidden md:flex items-center gap-3 px-4 py-2 bg-gray-800/50 rounded-xl">
                <div className="text-sm text-gray-400">Profile</div>
                <div className="flex items-center gap-2">
                  <Progress value={profileCompletion} className="w-24 h-2" />
                  <span className="text-sm font-semibold text-white">{Math.round(profileCompletion)}%</span>
                </div>
              </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <AnimatePresence>
          {message.text && (
            ...
            >
              <Alert 
                className={`mb-6 border backdrop-blur-xl ${
                  message.type === 'success' ? 'border-green-500 bg-green-500/10 text-green-300' :
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-9 gap-2 bg-gray-800/50 p-2 rounded-2xl">
            <TabsTrigger value="overview" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-500 data-[state=active]:to-pink-500 data-[state=active]:text-white">
              ...
              <span className="hidden lg:inline ml-2">Overview</span>
            </TabsTrigger>
            <TabsTrigger value="personal" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-500 data-[state=active]:to-pink-500 data-[state=active]:text-white">
              ...
              <span className="hidden lg:inline ml-2">Personal</span>
            </TabsTrigger>
            <TabsTrigger value="skills" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-500 data-[state=active]:to-pink-500 data-[state=active]:text-white">
              <Code2 className="h-4 w-4" />
              <span className="hidden lg:inline ml-2">Skills</span>
            </TabsTrigger>
            <TabsTrigger value="experience" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-500 data-[state=active]:to-pink-500 data-[state=active]:text-white">
              <Briefcase className="h-4 w-4" />
              <span className="hidden lg:inline ml-2">Experience</span>
            </TabsTrigger>
            <TabsTrigger value="education" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-500 data-[state=active]:to-pink-500 data-[state=active]:text-white">
              <GraduationCap className="h-4 w-4" />
              <span className="hidden lg:inline ml-2">Education</span>
            </TabsTrigger>
            <TabsTrigger value="projects" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-500 data-[state=active]:to-pink-500 data-[state=active]:text-white">
              ...
              <span className="hidden lg:inline ml-2">Projects</span>
            </TabsTrigger>
            <TabsTrigger value="testimonials" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-500 data-[state=active]:to-pink-500 data-[state=active]:text-white">
              <MessageSquare className="h-4 w-4" />
              <span className="hidden lg:inline ml-2">Reviews</span>
            </TabsTrigger>
            <TabsTrigger value="services" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-500 data-[state=active]:to-pink-500 data-[state=active]:text-white">
              <Wrench className="h-4 w-4" />
              <span className="hidden lg:inline ml-2">Services</span>
            </TabsTrigger>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-2xl font-bold text-white">
                            {portfolio?.skills?.reduce((acc: number, cat: any) => acc + (cat.items?.length || 0), 0) || 0}
                          </p>
                          <p className="text-xs text-gray-400 mt-1">Technical skills</p>
                        </div>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-2xl font-bold text-white">{Math.round(profileCompletion)}%</p>
                          <Progress value={profileCompletion} className="mt-2 h-1" />
                        </div>
